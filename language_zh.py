...
MANAGER_USER_PAGE = {
    ...
    "user_admin_update_role_prompt": "请输入新角色类型 (请输入 0 或 1, 0 -> 客户 1 -> 管理员): ",
    "user_admin_update_success_tip": "更新用户成功！",
    "user_admin_update_fail_tip": "更新用户失败，用户名不存在。",

    "user_admin_query_username_prompt": "请输入您要查询的用户名 (直接按回车键忽略此项): ",
    "user_admin_query_role_prompt": "请输入您要查询的角色类型 (请输入 0 或 1, 0 -> 客户 1 -> 管理员, 直接按回车键忽略此项): ",
...
MANAGER_CAR_PAGE = {
    "car_admin_welcome_tip": "欢迎管理系统车辆！",
    ...
    "car_admin_mileage_prompt": "请输入车辆里程: ",
    "car_admin_manufacturer_prompt": "请输入车辆制造商: ",
    "car_admin_daily_rent_prompt": "请输入车辆日租金: ",
    "car_admin_extra_fee_prompt": "请输入车辆额外费用: ",
    "car_admin_min_leasing_days_prompt": "请输入车辆最短租赁天数: ",
    "car_admin_max_leasing_days_prompt": "请输入车辆最长租赁天数: ",
    "car_admin_input_error": "输入无效，请检查。",
    ...
    "car_admin_query_min_mileage_prompt": "请输入您要查询的车辆最小里程: ",
    "car_admin_query_max_mileage_prompt": "请输入您要查询的车辆最大里程: ",
...
MANAGER_LEASE_APPLICATION_PAGE = {
    ...
    "lease_application_audit_type_prompt": "请输入审核结果 (请输入 1 或 2, 1 -> 同意 2 -> 拒绝): ",
    "lease_application_audit_message_prompt": "请输入拒绝原因 (直接按回车键跳过此项): ",
    "lease_application_admin_audit_success_tip": "审核租赁申请成功！",
    "lease_application_admin_audit_fail_tip": "审核租赁申请失败，请检查输入或联系系统管理员。",
    "lease_application_admin_input_error": "输入无效，请检查。",

}

MANAGER_LEASE_DETAILS_PAGE = {

    "lease_details_admin_welcome_tip": "欢迎管理系统租赁详情！",
    "query_details_option": "1. 查询租赁详情",
    "exit_option": "2. 返回管理员主页",
...
CUSTOMER_MAIN_PAGE = {
    ...
    "customer_view_cars_min_mileage_prompt": "请输入您要查询的车辆最小里程: ",
    "customer_view_cars_max_mileage_prompt": "请输入您要查询的车辆最大里程: ",
    ...
    "customer_book_car_start_time_prompt": "请输入租赁开始时间 (格式: dd-mm-yyyy): ",
    "customer_book_car_end_time_prompt": "请输入租赁结束时间 (格式: dd-mm-yyyy): ",
    "customer_book_car_confirm_prompt": "请确认预订，请注意总费用为 ",
    "customer_book_car_not_available_tip": "该车辆当前不可用或不存在，请检查。",
    ...
    "customer_book_car_input_error": "输入无效，请检查。",
}